...
numel(find(spec2spec0_vert~=0))/length(spec2spec0_vert)
numel(find(spec2spec1_vert~=0))/length(spec2spec1_vert)
numel(find(spec2spec2_vert~=0))/length(spec2spec2_vert)
numel(find(spec2spec3_vert~=0))/length(spec2spec3_vert)
numel(find(spec2spec4_vert~=0))/length(spec2spec4_vert)

numel(find(spec2gen0_vert~=0))/length(spec2gen0_vert)
numel(find(spec2gen1_vert~=0))/length(spec2gen1_vert)
numel(find(spec2gen2_vert~=0))/length(spec2gen2_vert)
numel(find(spec2gen3_vert~=0))/length(spec2gen3_vert)
numel(find(spec2gen4_vert~=0))/length(spec2gen4_vert)

numel(find(gen2spec0_vert~=0))/length(gen2spec0_vert)
numel(find(gen2spec1_vert~=0))/length(gen2spec1_vert)
numel(find(gen2spec2_vert~=0))/length(gen2spec2_vert)
numel(find(gen2spec3_vert~=0))/length(gen2spec3_vert)
numel(find(gen2spec4_vert~=0))/length(gen2spec4_vert)

scatter(numel(find(gen2gen0_vert~=0))/length(gen2gen0_vert))
numel(find(gen2gen1_vert~=0))/length(gen2gen1_vert)
numel(find(gen2gen2_vert~=0))/length(gen2gen2_vert)
numel(find(gen2gen3_vert~=0))/length(gen2gen3_vert)
numel(find(gen2gen4_vert~=0))/length(gen2gen4_vert)





sum(spec2spec0_vert)/length(spec2spec0_vert)
sum(spec2spec1_vert)/length(spec2spec1_vert)
sum(spec2spec2_vert)/length(spec2spec2_vert)
sum(spec2spec3_vert)/length(spec2spec3_vert)
sum(spec2spec4_vert)/length(spec2spec4_vert)
